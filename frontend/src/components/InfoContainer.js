...
export default function InfoContainer({enemyPokemon, allyPokemon, setGameData, setPage}) {
    ...
    <div className='info-container' data-testid='info-container'>
        {!battlehelper.gameData.gameOver ? (
            <div>
                ...
                <button className='attack-btn' onClick={() => handleAttack(enemyPokemon,allyPokemon)}>Attack</button>
            </div>
        ) : (
            <div>
